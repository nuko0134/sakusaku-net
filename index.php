...
<body>
        ...
        <div style="width: 100%;">
            <h1><a href="index.php"></p><span style="color: red;">サクサク</span><span class="logo_title_net">ネット</span></a></h1>
                <form action="search.php" method="get" class="search_container">
                    <input type="text" class="search_box_input" placeholder="キーワード..." name="keyword" value="">
                </form>
        </div>
    </main>
    </main>
    ...
    <hr>
        ...
        <p>記事内容・写真の著作権は元サイト様の作成者の方に帰属いたします。記事の著作権者はこのサービス（さくさくネット）の作成者（Komugikotan）ではありません。</p>
